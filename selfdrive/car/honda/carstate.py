...
class CarState(object):
  ...
  def update(self, cp, cp_cam):
    ...
    self.gear = 0 if self.CP.carFingerprint in (CAR.CIVIC or CAR.ACCORD_20_MANUAL) else cp.vl["GEARBOX"]['GEAR']
    ...
    can_gear_shifter = 8 if self.CP.carFingerprint in (CAR.ACCORD_20_MANUAL) else int(cp.vl["GEARBOX"]['GEAR_SHIFTER'])
